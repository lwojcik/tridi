...
class Tridi {
  ...
  private attachCosmeticEvents() {
    ...
    viewer.addEventListener("mouseenter", () => viewer.classList.add("tridi-viewer-hovered"));
    viewer.addEventListener("mouseleave", () => viewer.classList.remove("tridi-viewer-hovered"));
  }
